...
function Book(fm) {
    ...
    this.sort = function () {
        ...
        } else (this.input_power == 'flight' && this.input_character == 'rh' && this.input_animal == 'no') {
            return 0; // flight, rh, no-->adventure
        } else (this.input_power == 'flight' && this.input_character == 'nd' && this.input_animal == 'yes') {
            return 0; //flight, nd, yes->adventure 
        } else  (this.input_power == 'flight' && this.input_character == 'nd' && this.input_animal == 'no') {
            return 1; //flight, nd, no-> mystery  
        } else  (this.input_power == 'knowledge' && this.input_character == 'nd' && this.input_animal == 'yes') {
            return 1; //knowledge, nd, yes -> Mystery
        } else  (this.input_power == 'knowledge' && this.input_character == 'nd' && this.input_animal == 'no') {
...
var genre = ["Please select an option", "Adventure", "Mystery", "Fantasy", "History"]
