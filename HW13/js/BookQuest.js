...
//return box text 
    this.suggestion = function() {
        ...
        if (this.outdoors && this.notAnimals && this.flight) {
            return "You might like books about <b>History</b>. Here are some suggestions: <b>Ben Franklin's in my Bathroom! by Candace Fleming, The Bicycle Spy by Yona Zeldis McDonough</b>";
            }
